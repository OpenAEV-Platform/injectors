...
TECHNIQUES: List[Technique] = [
    ...
    Technique("aws.discovery.ses-enumerate", "aws", "Enumerate SES", ("T1526",)),
    Technique(
    ...
    Technique(
        "entra-id.persistence.guest-user",
        "entra-id",
        "Create Guest User",
        ("T1136.003",),
    ),
    ...
    Technique(
        "entra-id.persistence.new-application",
        "entra-id",
        "Create Application",
        ("T1136.003",),
    ),
    ...
    Technique(
        "gcp.defense-evasion.delete-logging-sink",
        "gcp",
    ...
    Technique(
        "gcp.defense-evasion.disable-logging-sink",
        "gcp",
