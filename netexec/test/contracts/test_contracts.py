...
from netexec.contracts import ParsedContractId, parse_contract_id
...
class ContractsTest(TestCase):
    ...
    def test_parse_base_protocol(self):
        ...
        self.assertEqual(
            result, ParsedContractId(protocol="smb", family="base", identifier=None)
        )
    ...
    def test_parse_option(self):
        ...
        self.assertEqual(
            result,
            ParsedContractId(protocol="smb", family="option", identifier="shares"),
        )
    ...
    def test_parse_module(self):
        ...
        self.assertEqual(
            result,
            ParsedContractId(protocol="smb", family="module", identifier="spider_plus"),
        )
