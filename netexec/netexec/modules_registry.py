...
NETEXEC_MODULES: list[dict] = [
    ...
    _mod(
        "adcs",
        "PKI Enrollment Services enumeration",
        ["ldap"],
        {
    ...
    _mod(
        ...
        ["ldap"],
        {
            ...
            "RIGHTS": _opt(
                "Rights filter: FullControl, ResetPassword, WriteMembers, DCSync"
            ),
    ...
    _mod(
        "dfscoerce",
        "[Removed] Check DFSCoerce vulnerability",
        ["smb"],
        {
    ...
    _mod(
        "drop-sc",
        "Drop searchConnector-ms on writable shares",
        ["smb"],
        {
    ...
    _mod(
        "enum_dns",
        "Dump DNS from AD DNS Server via WMI",
        ["smb", "wmi"],
        {
    ...
    _mod(
        "exec_on_link",
        "Execute commands on linked SQL server",
        ["mssql"],
        {
    ...
    _mod(
        "firefox",
        "[Removed] Dump Firefox credentials",
        ["smb"],
        {
    ...
    _mod(
        "get-desc-users",
        "Get user descriptions (may contain passwords)",
        ["ldap"],
        {
    ...
    _mod(
        "get-network",
        "Query DNS records with IPs from domain",
        ["ldap"],
        {
    ...
    _mod(
        "group-mem",
        "[Removed] Retrieve group members",
        ["ldap"],
        {
    ...
    _mod(
        "groupmembership",
        "Query groups a user belongs to",
        ["ldap"],
        {
    ...
    _mod(
        "handlekatz",
        "Dump lsass with handlekatz64 + pypykatz",
        ["smb"],
        {
    ...
    _mod(
        "hash_spider",
        "Recursive lsass dump via BloodHound local admins",
        ["smb"],
        {
    ...
    _mod(
        "impersonate",
        "List/impersonate tokens for command execution",
        ["smb"],
        {
    ...
    _mod(
        "ioxidresolver",
        "Identify hosts with additional interfaces",
        ["smb", "wmi"],
        {
    ...
    _mod(
        "keepass_discover",
        "Search for KeePass files and processes",
        ["smb"],
        {
    ...
    _mod(
        "keepass_trigger",
        "Set up malicious KeePass trigger for export",
        ["smb"],
        {
    ...
    _mod(
        "link_xpcmd",
        "Run xp_cmdshell on linked SQL server",
        ["mssql"],
        {
    ...
    _mod(
        "lsassy",
        "Dump lsass remotely with lsassy",
        ["smb"],
        {
    ...
    _mod(
        "masky",
        "Dump domain creds via ADCS and KDC",
        ["smb"],
        {
    ...
    _mod(
        "met_inject",
        "Inject Meterpreter stager into memory",
        ["smb", "mssql"],
        {
    ...
    _mod(
        "mssql_coerce",
        "SQL coercion/exfiltration via listener",
        ["mssql"],
        {
    ...
    _mod(
        "nanodump",
        "Dump lsass with nanodump + pypykatz",
        ["smb", "mssql"],
        {
            "TMP_DIR": _opt("Path on target for dump"),
    ...
    _mod(
        "petitpotam",
        "[Removed] Check PetitPotam vulnerability",
        ["smb"],
        {
    ...
    _mod(
        "pi",
        "Process injection - run command as logged user",
        ["smb"],
        {
    ...
    _mod(
        "powershell_history",
        "Extract PowerShell history for all users",
        ["smb"],
        {
    ...
    _mod(
        "printerbug",
        "[Removed] Check PrinterBug vulnerability",
        ["smb"],
        {
            "LISTENER": _opt("Listener address"),
        },
    ...
    _mod(
        "printnightmare",
        "Check PrintNightmare vulnerability",
        ["smb"],
        {
    ...
    _mod(
        "procdump",
        "Dump lsass with procdump64 + pypykatz",
        ["smb"],
        {
            "TMP_DIR": _opt("Path on target for dump"),
    ...
    _mod(
        "remove-mic",
        "Check CVE-2019-1040 vulnerability",
        ["smb"],
        {
            "PORT": _opt("Port to check"),
        },
    ...
    _mod(
        "sccm",
        "Find SCCM infrastructure in AD",
        ["ldap"],
        {
            "BASE_DN": _opt("Base domain name for LDAP query"),
    ...
    _mod(
        "schtask_as",
        "Execute scheduled task as logged on user",
        ["smb"],
        {
    ...
    _mod(
        "scuffy",
        "Create/upload .scf for NTLMv2 hash looting",
        ["smb"],
        {
    ...
    _mod(
        "shadowcoerce",
        "[Removed] Check ShadowCoerce vulnerability",
        ["smb"],
        {
    ...
    _mod(
        "slinky",
        "Create LNK shortcuts with UNC icon on shares",
        ["smb"],
        {
    ...
    _mod(
        "snipped",
        "Download Snipping Tool screenshots",
        ["smb"],
        {
    ...
    _mod(
        "spider_plus",
        "Recursively list/download share files",
        ["smb"],
        {
    ...
    _mod(
        "timeroast",
        "Timeroasting - request password hashes via NTP",
        ["smb"],
        {
    ...
    _mod(
        "vnc",
        "Loot VNC server and client passwords",
        ["smb"],
        {
    ...
    _mod(
        "wdigest",
        "Enable/disable WDigest credential dumping",
        ["smb"],
        {
    ...
    _mod(
        "web_delivery",
        "Metasploit web_delivery module execution",
        ["smb", "mssql"],
        {
    ...
    _mod(
        "winscp",
        "Extract WinSCP credentials from registry",
        ["smb"],
        {
