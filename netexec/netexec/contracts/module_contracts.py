...
from netexec.contracts.attack_pattern_registry import get_module_attack_patterns
...
def _build_module_contract(
    ...
    return Contract(
        ...
        contract_attack_patterns_external_ids=get_module_attack_patterns(safe_name),
    )
