...
* ajouter un **JSON schema exact** pour le trigger HTTP
* documenter un **exemple de payload réel OpenAEV**
* ou ajouter une section **Troubleshooting** (timeouts, 401, messages non reçus, etc.)
