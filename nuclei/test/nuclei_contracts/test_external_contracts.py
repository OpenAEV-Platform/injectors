...
class ExternalContractsTest(unittest.TestCase):
    ...
    def test_when_no_preexisting_contract_create_all_from_templates(
        ...
        tested = ExternalContractsManager(
            mock_obas_client, self.INJECTOR_ID, self.LOGGER
        )
