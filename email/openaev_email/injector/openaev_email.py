...
from openaev_email.services import EmailClient, EmailPayloadBuilder, ExecutionResult
...
class EmailInjector:
    ...
    def _build_output_structured(
        ...
        signatures = EmailSignatureService.build_email_signatures(
            ...
            hash_algorithm=self.config.email.hash_algorithm,
        )
        if not signatures:
            return {}
