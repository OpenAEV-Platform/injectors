...
from openaev_email.services.email_client import SMTP_TIMEOUT_SECONDS, EmailClient
...
def test_send_email_rejects_incomplete_credentials():
    with patch("smtplib.SMTP") as mock_smtp:
        result = EmailClient.send_email(
            smtp_hostname="localhost",
            smtp_port=1025,
        ...
        assert result.message == "SMTP username and password must both be provided"
