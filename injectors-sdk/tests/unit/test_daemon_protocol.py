"""Tests for DaemonProtocol re-export from injectors_sdk."""
...
def test_daemon_protocol_importable_from_injectors_sdk() -> None:
    """DaemonProtocol is importable from injectors_sdk."""
...
def test_daemon_protocol_is_same_as_xtm_oaev_sdk() -> None:
    ...
    from injectors_sdk import DaemonProtocol as FromInjectors
