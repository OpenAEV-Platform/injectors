"""Essential tests for Shodan CVE Specific Watchlist contract - Gherkin GWT Format."""
...
@pytest.mark.parametrize(
    "vulnerability, hostname, organization, expected_targets, expected_query_fragments_per_target, search_responses, user_info_response",
    [
        (
            "CVE-2023-44487",
            "filigran.io",
        ...
        (
            "CVE-2023-44487,CVE-2019-8936",
            "filigran.io,google.com",
            "",
            ["filigran.io", "google.com"],
            [
                [
                    "vuln:CVE-2023-44487,CVE-2019-8936",
                    "hostname:filigran.io,*.filigran.io",
                    "org:filigran.io",
                ],
                [
    ...
    ids=[
        "single_cve_single_hostname_with_organization",
        "multi_cve_multi_hostname_without_organization",
    ],
)
def test_cve_specific_watchlist_with_valid_vulnerability_and_hostname_and_organization(
    shodan_client_api,
    vulnerability,
    hostname,
    organization,
...
def _when_execute_cve_specific_watchlist(
    ...
    """Execute the CVE Specific Watchlist contract through process_shodan_search.
