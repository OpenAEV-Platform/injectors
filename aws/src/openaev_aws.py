...
from contracts_aws import (CLOUDTRAIL_ENUM_CONTRACT, COGNITO_ENUM_CONTRACT,
                           DYNAMODB_ENUM_CONTRACT, EBS_ENUM_SNAPSHOTS_CONTRACT,
                           EC2_ENUM_INSTANCES_CONTRACT,
                           EC2_ENUM_SECURITY_GROUPS_CONTRACT,
                           ECR_ENUM_CONTRACT, ECS_ENUM_CONTRACT,
                           EKS_ENUM_CONTRACT, GLUE_ENUM_CONTRACT,
                           GUARDDUTY_ENUM_CONTRACT, IAM_CREATE_USER_CONTRACT,
                           IAM_ENUM_PERMISSIONS_CONTRACT,
                           IAM_ENUM_ROLES_CONTRACT, IAM_ENUM_USERS_CONTRACT,
                           IAM_GET_PASSWORD_POLICY_CONTRACT,
                           IAM_PRIVESC_SCAN_CONTRACT,
                           LAMBDA_ENUM_FUNCTIONS_CONTRACT,
                           ORGANIZATIONS_ENUM_CONTRACT,
                           RDS_ENUM_DATABASES_CONTRACT, ROUTE53_ENUM_CONTRACT,
                           S3_DOWNLOAD_BUCKET_CONTRACT,
                           S3_ENUM_BUCKETS_CONTRACT,
                           SECRETS_MANAGER_ENUM_CONTRACT, SNS_ENUM_CONTRACT,
                           SSM_ENUM_PARAMETERS_CONTRACT, VPC_ENUM_CONTRACT,
                           AWSContracts)
